    ...
    <React.Fragment>
      <Content>
        ...
        <Switch>
          <Route
            exact
            path={`${process.env.PUBLIC_URL}/crypto/user-profile-regular`}
          ...
          <Route
            exact
            path={`${process.env.PUBLIC_URL}/crypto/user-profile-connected`}
            render={() => <UserProfileConnectedPage updateSm={updateSm} sm={sm} />}
          ></Route>
          <Route
            exact
            path={`${process.env.PUBLIC_URL}/crypto/user-profile-setting`}
